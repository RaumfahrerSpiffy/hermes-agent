...
class SessionDB(SessionSearchMixin, SessionSchemaMixin, SessionPortabilityMixin):
    ...
    def append_message(
        ...
        # MERCURY FORK: persist anthropic_content_blocks (Option B —
        # upstream efcbbde48 in-memory-only reversal not adopted).
        ...
        def _do(conn):
            ...
            cursor = conn.execute(
                """INSERT INTO messages (session_id, role, content, tool_call_id,
                   ...
                   reasoning, reasoning_content, reasoning_details, anthropic_content_blocks, codex_reasoning_items,
