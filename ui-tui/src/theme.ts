...
export const DARK_SEEDS: ThemeSeeds = {
  // MERCURY FORK: silver-steel identity seeds (values from the committed
  // pre-refactor DARK_THEME literal, 2f0a5d4be — anti-gold-flash first frame).
  // surface/activeRow/selection/muted are IDENTITY fills, pinned via the
  // explicit override fields so the mix ladder cannot drift them.
  accent: '#9FB6C9',
  activeRow: '#3f4254',
  bg: '#101014',
  border: '#6E7681',
